...
public class GetScopesResponse {
	...
	public String toString() {
		String s = "GetScopesResponse:";
		for(Scopes scopes:ScopesList) {
			s += scopes.toString() + ";";
		}
		return s;
	}
